...
namespace HotelRoomFinder.Migrations
{
    ...
    [Migration("20220119173056_AddOneToOneBetweenUserAndHotel")]
    partial class AddOneToOneBetweenUserAndHotel
    {
            ...
            modelBuilder.Entity("HotelRoomFinder.Models.Entities.Hotel", b =>
                {
                    b.HasOne("HotelRoomFinder.Models.Entities.User", "User")
                        .WithOne("hotel")
                        .HasForeignKey("HotelRoomFinder.Models.Entities.Hotel", "UserId");
